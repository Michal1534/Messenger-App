            ...
            <Box flex={1} alignItems="center" justifyContent="flex-start">
                ...
                <Box mb={"50px"} alignItems="center" justifyContent="flex-start">
                    ...
                    <Box alignItems="flex-start" justifyContent="flex-start">
                        ...
                        <Text >2.	Przycisk dzięki któremu na wskazany adres e-mail dostaniemy wiadomość mailową z linkiem, który prowadzi nas do strony na której wpisujemy nowe hasło do aplikacji.</Text>
                    </Box>
                </Box>
                <Box mb={"50px"} alignItems="center" justifyContent="flex-start">
                    ...
                    <Box alignItems="flex-start" justifyContent="flex-start">
                        <Text >1.	Awatar naszego konta po kliknięciu w niego zmienia nam się status na 1 z 3 możliwych takich jak: „online”, „afk”, „offline”</Text>
                ...
                <Box mb={"50px"} alignItems="center" justifyContent="flex-start">
                    ...
                    <Box alignItems="flex-start" justifyContent="flex-start">
                        ...
                        <Text >2. Prosta wyszukiwarka, w której możemy wpisać nazwę użytkownika lub grupę po której chcemy kogoś wyszukać.</Text>
                        <Text >3. Informacja do której grupy należą dani użytkownicy, domyślnie nowy znajomy trafia do grupy pozostali.</Text>
                        <Text >4. Tak wyświetlani są nasi znajomi.</Text>
                        <Text >5. Przycisk przenoszący nas do ekranu, w którym możemy dodawać użytkowników do znajomych.</Text>
                    </Box>
                </Box>
                <Box mb={"50px"} alignItems="center" justifyContent="flex-start">
                    ...
                    <Box alignItems="flex-start" justifyContent="flex-start">
                        ...
                        <Text >5.	Wiadomość wysłana przez nas (posiada ona nieco ciemniejszy odcień porównując z wiadomością oznaczoną pkt 6 gdyż została ona zapisane. Aby zapisać wiadomość należy kliknąć na wiadomość która chcemy zapisać)</Text>
                        <Text >6.	Wiadomość wysłana przez nas pod wiadomością znajduje się czas jaki minął od wysłania wiadomości</Text>
                ...
                <Box mb={"50px"} alignItems="center" justifyContent="flex-start">
                    ...
                    <Box alignItems="flex-start" justifyContent="flex-start">
                        <Text >1.	4 różne kolory, które po kliknięciu zmieniają nam tło w konwersacji z konkretnym znajomym.</Text>
                        <Text >2.	Miejsce w którym możemy wpisać nową nazwę użytkownika</Text>
                        <Text >3.	Przycisk do zatwierdzenia nowej nazwy użytkownika (Wciśnięcie tego przycisku gdy pkt 2 jest pusty usunie przypisaną użytkownikowi nazwę)</Text>
                        <Text >4.	Wybranie grupy do której dany znajomy należy</Text>                    </Box>
                </Box>
                <Box alignItems="center" justifyContent="flex-start">
                    ...
                    <Box alignItems="flex-start" justifyContent="flex-start">
                        <Text >1.	Wyświetlane zostają tutaj tylko zapisane przez nas wiadomości jak widzimy czas wyświetla się w innej formie gdyż pokazywana jest data z której pochodzi dana wiadomość, a nie czas który minął od wysłania wiadomości</Text>
                    </Box>
                </Box>
            </Box>
        </ScrollView>
