...
import { Box, Input, Button, Text, AlertDialog, Icon, Modal, ScrollView, Image } from 'native-base';
...
export const ChangePassword = () => {
    ...
    return (
        <Box paddingLeft={'4'} paddingRight={'4'} backgroundColor={'white'} flex={1}>
                    ...
                    <Modal.Body>
                        <ScrollView>
                            ...
                            <Box alignItems="flex-start" justifyContent="flex-start">
                                ...
                                <Text>
                                    3. Miejsce, w które wpisujemy nowe hasło (automatycznie uzupełniane po kliknięciu
                                    przycisku z pkt 1)
                                </Text>
                                <Text>
                                    4. Miejsce, w które wpisujemy ponownie nowe hasło (automatycznie uzupełniane po
                                    kliknięciu przycisku z pkt 1)
                                </Text>
            ...
            <Text mt={10}>
                Hey {user?.displayName || user?.email}. If you want to change your password please type your current
                password and new password. Remember to have a strong password, we can also generate it for you.
            </Text>
            <Button my={5} variant="subtle" onPress={generatePassword}>
