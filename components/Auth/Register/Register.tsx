...
import { Box, VStack, Heading, Input, Button, Modal, ScrollView, Image, Text, Icon, Stack, useNativeBase } from "native-base";
...
import App, { StackProps } from "../../../App";
  ...
  return (<Box flex={1}>
    ...
    <VStack space="3" justifyContent="space-between" width={200}>
      ...
      <Controller
        ...
        name="password"
      />
      <Button onPress={handleSubmit(onSubmit)} size="lg">Register</Button>
    </VStack>
    </Box>
  </Box>)
}