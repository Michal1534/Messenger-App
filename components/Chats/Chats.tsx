        ...
        <Box flex={1} alignItems="stretch" justifyContent="center">
                        ...
                        <ScrollView>
                            <Box alignItems="center" justifyContent="flex-start">
                                ...
                                <Box alignItems="flex-start" justifyContent="flex-start">
                                    <Text>
                                        1. Nazwa użytkownika z którym pisaliśmy oraz ostatnia wiadomość w konwersacji z
                                        tym użytkownikiem.
                                    </Text>
                                    <Text>
                                        2. Czas który minął od ostatniej wiadomości z konwersacji do aktualnego czasu.
                                    </Text>
                                    <Text>
                                        3. Informacja wyświetlana tylko przy nieodczytanych wiadomościach, w środku
                                        znajduję się informacja o ilości tych wiadomości.
                                    </Text>
                                </Box>
                            </Box>
                        </ScrollView>
            ...
            <FlatList
                ...
                renderItem={({ item }: { item: Conversation }) => (
                    ...
                    >
                        <Box borderBottomWidth="1" borderColor="gray.200" paddingX={3} paddingY={3}>
                            <HStack space={3} justifyContent="space-between">
                                <Avatar size="md">{item.user.slice(0, 2)}</Avatar>
                                <VStack>
                                    <HStack space={1} justifyContent="flex-start" alignItems="center">
                                        <Text color="gray.800" bold>
                                            {item.user}
                                        </Text>
                                        {item.unread > 0 && (
                                            <Badge
                                    ...
                                    <Text color="gray.500">{item.messages[item.messages.length - 1].message}</Text>
                                </VStack>
                                <Spacer />
